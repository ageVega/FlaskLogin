...
file_paths = [
    ...
    os.path.join(script_dir, os.pardir, 'templates', 'change_password.html'),
    os.path.join(script_dir, os.pardir, 'templates', 'delete_admin.html'),
    ...
    os.path.join(script_dir, os.pardir, 'static', 'js', 'modules', 'delete_admin.js'),
